	...
	<div class="content">
		<div class="content-right">
			...
			<div class="post-anons<?php echo $cat_right; ?>">
				...
				<a href="<?php the_permalink(); ?>" title=""><img class="tour" width="160" height="100" src="<?php echo $cat_image; ?>" alt="" /></a>
				<a class="post-anons-title tour" href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
