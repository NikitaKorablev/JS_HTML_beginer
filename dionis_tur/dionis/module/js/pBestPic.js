...
var _sc = {
  ...
  loadDepartCities: function ()
  {
    ...
    mAjax.getDepartCities(mSettings.sc.templateBest, callback);
  },
  ...
  loadCountries: function ()
  {
    ...
    mAjax.getCountries(mSettings.sc.templateBest,1, $('#ht_cityFrom').val(), callback);
  },
  ...
  loadTours: function ()
  {
    ...
    mAjax.getShowcase(mSettings.sc.templateBest,
      150,
  ...
  fillTours: function (data)
  {
    ...
    if (!mSettings.showExternalLinksOnBlankPage && (!$.browser.msie || mSettings.thGateway))
    {
