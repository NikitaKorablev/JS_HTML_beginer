...
//task 1
console.log("---------task 1----------");
let square = (digit) => {return digit*digit};
console.log("square of the digit =", square(6))

//task 2
console.log("---------task 2----------");
let sum = (digit_1, digit_2) => {return digit_1 + digit_2};
let firstDigit = 6, secondDigit = 5;
...
//task 5
console.log("---------task 5----------");
let equal = (digit_1, digit_2) => {return digit_1 == digit_2};
firstDigit = 4, secondDigit = 4;
console.log(firstDigit, "==", secondDigit, ":", equal(firstDigit, secondDigit));

//task 6
console.log("---------task 6----------");
let moreThen = (digit_1, digit_2) => {return (digit_1 + digit_2) > 10}
firstDigit = 3, secondDigit = 5;
console.log(firstDigit, "+", secondDigit, "> 10 :", moreThen(firstDigit, secondDigit));

//task 7
console.log("---------task 7----------");
let isNegative = (digit) => {return digit < 0};
let digit = -3;
